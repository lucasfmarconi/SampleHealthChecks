...
// This is an example of a custom health check that implements IHealthCheck. See CustomWriterStartup to see how
// this health check is registered.
//
// This example also shows a technique for authoring a health check that requires registration with additional
// configuration data. This technique works via named options and is useful for authoring health checks that
// will be distributed as libraries.
